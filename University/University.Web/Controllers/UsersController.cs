...
public class UsersController : Controller
{
    ...
    {   
        var userTypes = Enum.GetValues(typeof(UserType)).Cast<UserType>();
    ...
    public IActionResult Create(UserDto model)
    {
        if (ModelState.IsValid)
        {
            ...
            else
            {
                ...
                ViewBag.UserTypes = new SelectList(Enum.GetValues(typeof(UserType)).Cast<UserType>()); // Set ViewBag.UserTypes if needed
                ViewBag.Universities = _universityService.GetUniversities();
